...
### 📝 Current Research Topic (석사 과정)
**"GAS 및 상황 인지 애니메이션 노드를 활용한 실시간 부위 파괴 기반의 정밀 액션 게임 아키텍처 연구"**

### 🔬 Research Interests
*게임플레이의 본질을 관통하는 기술적 난제들을 탐구합니다.*

- **Combat Feedback & Feel:** 입력 지연(Input Latency) 최소화 및 타격감을 극대화하는 컴포넌트 설계
- **Context-Aware Animation:** 상황 인식 시스템과 애니메이션 노드 그래프를 활용한 동적 전투 로직 구현
- **Gameplay Architecture:** GAS(Gameplay Ability System)를 활용한 확장성 높은 능력 시스템 설계 및 컴포넌트 결합도 최적화
